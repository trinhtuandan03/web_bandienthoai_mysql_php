...
<!-- Mirrored from htmldemo.net/elehaus/elehaus/shop-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2024 08:39:17 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="/public/css/plugins/range-slider.css">
...
<body>
    ...
    <div class="wrapper">
                        ...
                        <div class="col-auto">
                            <!-- <div class="vertical-menu">
                                ...
                                <ul class="vmenu-content vmenu-content-none">
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm1.png" alt="Icon"></span> Headphone</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm2.png" alt="Icon"></span> Video Game</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm3.png" alt="Icon"></span> Protable Speakers</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm4.png" alt="Icon"></span> Digital Camera</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm5.png" alt="Icon"></span> Gadgets</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm6.png" alt="Icon"></span> Home Appliances</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm7.png" alt="Icon"></span> Audio Record</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img src="/public/images/icons/vm8.png" alt="Icon"></span> Computer/Laptop</a>
                                    </li>
                                </ul>
                                 menu content 
                        </div> -->
                                ...
                                <div class="tab-pane fade show active" id="column-three" role="tabpanel"
                                    ...
                                    <div class="row mb-n6">
                                        <div class="col-sm-6 col-lg-6 col-xl-4 mb-6">
                                            ...
                                            <div class="product-item">
                                                <a class="product-item-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/1.jpg" width="270" height="264"
                                                        alt="Image-HasTech">
                                                </a>
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-xl-4 mb-6">
                                            ...
                                            <div class="product-item">
                                                <a class="product-item-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/14.jpg" width="270" height="264"
                                                        alt="Image-HasTech">
                                                </a>
                                                <span class="badges">-10%</span>
                                                <div class="product-item-action">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-xl-4 mb-6">
                                            ...
                                            <div class="product-item">
                                                <a class="product-item-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/15.jpg" width="270" height="264"
                                                        alt="Image-HasTech">
                                                </a>
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 mb-n8">
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p7.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                        ...
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item border-0">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p8.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                                <div class="product-list-info">
                                                    <h5 class="product-list-title"><a
                                        ...
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p9.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                                <div class="product-list-info">
                                                    <h5 class="product-list-title"><a
                                        ...
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item border-0">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p10.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                                <div class="product-list-info">
                                                    <h5 class="product-list-title"><a
                                        ...
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p11.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                                <div class="product-list-info">
                                                    <h5 class="product-list-title"><a
                                        ...
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item border-0">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p12.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                                <div class="product-list-info">
                                                    <h5 class="product-list-title"><a
                                        ...
                                        <div class="col mb-8">
                                            ...
                                            <div class="product-list-item">
                                                <a class="product-list-thumb" href="shop-single-product.html">
                                                    <img src="/public/images/shop/p13.jpg" width="107" height="107"
                                                        alt="Image-HasTech">
                                                </a>
                                                <div class="product-list-info">
                                                    <h5 class="product-list-title"><a
                            ...
                            <div class="sidebar-area mt-10 mt-lg-0">
                                <div class="widget-item widget-item-one pb-5">
                                    ...
                                    <div class="widget-categories-list">
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm1.png" alt="Icon"></span> Headphone (32)
                                        </a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm2.png" alt="Icon"></span> Video Game
                                            (12)
                                        </a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm3.png" alt="Icon"></span> Protable
                                            Speakers (19)</a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm4.png" alt="Icon"></span> Digital Camera
                                            (25)
                                        </a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm5.png" alt="Icon"></span> Gadgets (15)
                                        </a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm6.png" alt="Icon"></span> Home
                                            Appliances (45)</a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm7.png" alt="Icon"></span> Audio Record
                                            (25)
                                        </a>
                                        <a class="widget-category-item" href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm8.png" alt="Icon"></span>
                                    ...
                                    <div class="widget-product-items">
                                        <a href="shop.html" class="widget-product-two-item">
                                            <div class="widget-product-two-thumb">
                                                <img src="/public/images/shop/w1.png" width="70" height="70"
                                                    alt="Image">
                                            </div>
                                        ...
                                        <a href="shop.html" class="widget-product-two-item">
                                            <div class="widget-product-two-thumb">
                                                <img src="/public/images/shop/w2.png" width="70" height="70"
                                                    alt="Image">
                                            </div>
                                            <div class="widget-product-content">
                                        ...
                                        <a href="shop.html" class="widget-product-two-item">
                                            <div class="widget-product-two-thumb">
                                                <img src="/public/images/shop/w3.png" width="70" height="70"
                                                    alt="Image">
                                            </div>
                                            <div class="widget-product-content">
                                ...
                                <div class="widget-item mb-0 p-0">
                                    <div class="widget-banner product-banner-eight-item"
                                        data-bg-img="/public/images/shop/banner/20.png">
                                        ...
                                        <img class="ms-1" src="/public/images/shop/banner/21.png" width="225"
                                            height="201" alt="Image-HasTech">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row row-gutter-0">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="thumb-item">
                                                            <img src="/public/images/shop/details/m1.jpg" alt="Image"
                                                                width="640" height="710">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumb-item">
                                                            <img src="/public/images/shop/details/m2.jpg" alt="Image"
                                                                width="640" height="710">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumb-item">
                                                            <img src="/public/images/shop/details/m3.jpg" alt="Image"
                                                                width="640" height="710">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="product-detail-content mt-6 mt-lg-0">
                                        <h2 class="product-detail-title mt-n1 me-10">Android Television Super Salon New
                                            DGT -256</h2>
                                        <div class="product-detail-price">$160.00 - <span
                                                class="price-old">$260.00</span></div>
                                        ...
                                        <p class="product-detail-desc">Lorem ipsum dolor sit amet, consectetur
                                            adipisicing elit, sed do eiusmo tempor incididunt ut labore et dolore magna
                                            aliqua. Ut enim ad minimo veniam, quis nostrud exercitation ullamco laboris
                                            nisi.
                                        </p>
                                        <div class="mb-3">
                                        ...
                                        <div>
                                            ...
                                            <button type="button" class="product-detail-wishlist-btn"
                                                data-bs-toggle="modal" data-bs-target="#action-WishlistModal">
                    ...
                    <div class="modal-body">
                        <div class="product-action-view-content">
                            ...
                            <div class="modal-action-product">
                                <div class="thumb">
                                    <img src="/public/images/shop/modal1.jpg" alt="Organic Food Juice" width="466"
                                        height="320">
                                </div>
                        ...
                        <div class="cart-content cart-content-padding">
                            <ul>
                                <li class="single-product-cart">
                                    <div class="cart-img">
                                        <a href="shop-single-product.html"><img src="/public/images/shop/s3.jpg"
                                ...
                                <li class="single-product-cart">
                                    <div class="cart-img">
                                        <a href="shop-single-product.html"><img src="/public/images/shop/s4.jpg"
                                                alt="Image" width="70" height="67"></a>
                                    </div>
                                    <div class="cart-title">
        ...
        <aside class="aside-side-menu-wrapper off-canvas-area offcanvas offcanvas-end" data-bs-scroll="true"
            ...
            <div class="sidemenu-top">
                ...
                <div class="header-info-dropdown">
                    <button type="button" class="btn-info dropdown-toggle" id="dropdownCurrency2"
                        data-bs-toggle="dropdown" aria-expanded="false">USD</button>
    ...
    <script src="/public/js/plugins/range-slider.js"></script>
