                    ...
                    <div class="row align-items-center justify-content-between align-items-center">
                        <div class="col-auto">
                            <div class="header-logo-area">
                                <a href="index.html">
                                    <img class="logo-main" src="/public/images/logo.png" width="182" height="31" alt="Logo">
                                </a>
                            </div>
                        </div>
                        <div class="col-auto">
                                ...
                                <ul class="vmenu-content vmenu-content-none">
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm1.png" alt="Icon"></span> Headphone</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm2.png" alt="Icon"></span> Video Game</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm3.png" alt="Icon"></span> Protable Speakers
                                        </a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                    ...
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm5.png" alt="Icon"></span> Gadgets</a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm6.png" alt="Icon"></span> Home Appliances
                                        </a>
                                    </li>
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                    ...
                                    <li class="vmenu-item">
                                        <a href="shop.html"> <span class="icon"><img
                                                    src="/public/images/icons/vm8.png" alt="Icon"></span> Computer/Laptop
                                        </a>
                                    </li>
                                </ul>
                                <!-- menu content -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="page-header-thumb">
                                <img src="/public/images/photos/page-title.png" alt="Image-HasTech" width="546" height="281">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="product-detail-thumb me-lg-6">
                                <div class="swiper single-product-thumb-slider">
                                    <div class="swiper-wrapper">
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="/public/images/shop/details/1.jpg">
                                            <img src="/public/images/shop/details/1.jpg" width="640" height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="/public/images/shop/details/2.jpg">
                                            <img src="/public/images/shop/details/2.jpg" width="640" height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="/public/images/shop/details/3.jpg">
                                            <img src="/public/images/shop/details/3.jpg" width="640" height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery" href="/public/images/shop/details/4.jpg">
                                            <img src="/public/images/shop/details/4.jpg" width="640" height="530" alt="Image">
                                        </a>
                                    </div>
                                    <!-- swiper pagination -->
                                    ...
                                    <div class="swiper single-product-nav-slider">
                                        <div class="swiper-wrapper">
                                            <div class="nav-item swiper-slide">
                                                <img src="/public/images/shop/details/nav1.jpg" alt="Image" width="127" height="127">
                                            </div>
                                            <div class="nav-item swiper-slide">
                                                <img src="/public/images/shop/details/nav2.jpg" alt="Image" width="127" height="127">
                                            </div>
                                            <div class="nav-item swiper-slide">
                                                <img src="/public/images/shop/details/nav3.jpg" alt="Image" width="127" height="127">
                                            </div>
                                            <div class="nav-item swiper-slide">
                                                <img src="/public/images/shop/details/nav4.jpg" alt="Image" width="127" height="127">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-n3">
                                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-3">
                                            ...
                                            <div class="feature-two-item">
                                                <img class="icon" src="/public/images/icons/1.png" width="44" height="38" alt="Icon"> <span class="feature-two-title">Support 24/7</span>
                                            </div>
                                            <!--== End Feature Item ==-->
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-3">
                                            <!--== Start Feature Item ==-->
                                            <div class="feature-two-item">
                                                <img class="icon" src="/public/images/icons/3.png" width="48" height="38" alt="Icon"> <span class="feature-two-title">Card Payment</span>
                                            </div>
                                            <!--== End Feature Item ==-->
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-3">
                                            <!--== Start Feature Item ==-->
                                            <div class="feature-two-item">
                                                <img class="icon" src="/public/images/icons/4.png" width="50" height="38" alt="Icon"> <span class="feature-two-title">Free Shipping</span>
                                            </div>
                                            <!--== End Feature Item ==-->
                                        </div>
                                    </div>
                    ...
                    <div class="tab-content" id="product-detail-nav-tabContent">
                        ...
                        <div class="tab-pane" id="review" role="tabpanel" aria-labelledby="review-tab">
                            ...
                            <div class="product-review-item">
                                <div class="product-review-top">
                                    <div class="product-review-thumb">
                                        <img src="/public/images/shop/details/c1.png" alt="Images">
                                    </div>
                            ...
                            <div class="product-review-item product-review-reply">
                                <div class="product-review-top">
                                    <div class="product-review-thumb">
                                        <img src="/public/images/shop/details/c2.png" alt="Images">
                                    </div>
                                    <div class="product-review-content">
                            ...
                            <div class="product-review-item mb-0">
                                <div class="product-review-top">
                                    <div class="product-review-thumb">
                                        <img src="/public/images/shop/details/c3.png" alt="Images">
                                    </div>
                                    <div class="product-review-content">
                    ...
                    <div class="swiper related-product-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="/public/images/shop/5.jpg" width="270" height="264" alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="/public/images/shop/6.jpg" width="270" height="264" alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="/public/images/shop/7.jpg" width="270" height="264" alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="/public/images/shop/8.jpg" width="270" height="264" alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="row row-gutter-0">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <div class="thumb-item">
                                                            <img src="/public/images/shop/details/m1.jpg" alt="Image" width="640" height="710">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumb-item">
                                                            <img src="/public/images/shop/details/m2.jpg" alt="Image" width="640" height="710">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <div class="thumb-item">
                                                            <img src="/public/images/shop/details/m3.jpg" alt="Image" width="640" height="710">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Add Arrows -->
                                ...
                                <div class="col-lg-6">
                                    <div class="product-detail-content mt-6 mt-lg-0">
                                        ...
                                        <p class="product-detail-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmo tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minimo veniam, quis nostrud exercitation ullamco laboris nisi.
                                        </p>
                                        <div class="mb-3">
                    ...
                    <div class="modal-body">
                        <div class="product-action-view-content">
                            ...
                            <div class="modal-action-product">
                                <div class="thumb">
                                    <img src="/public/images/shop/modal1.jpg" alt="Organic Food Juice" width="466" height="320">
                                </div>
                        ...
                        <div class="cart-content cart-content-padding">
                            <ul>
                                <li class="single-product-cart">
                                    <div class="cart-img">
                                        <a href="shop-single-product.html"><img src="/public/images/shop/s3.jpg" alt="Image" width="70" height="67"></a>
                                    </div>
                                ...
                                <li class="single-product-cart">
                                    <div class="cart-img">
                                        <a href="shop-single-product.html"><img src="/public/images/shop/s4.jpg" alt="Image" width="70" height="67"></a>
                                    </div>
                                    <div class="cart-title">
