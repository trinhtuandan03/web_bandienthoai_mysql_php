            ...
            <div class="product-detail-area section-space">
                <div class="container">
                                ...
                                <div class="swiper single-product-thumb-slider">
                                    <div class="swiper-wrapper">
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery"
                                            href="<?= BASE_URL ?>/public/images/shop/details/1.jpg">
                                            <img src="<?= BASE_URL ?>/public/images/shop/details/1.jpg" width="640"
                                                height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery"
                                            href="<?= BASE_URL ?>/public/images/shop/details/2.jpg">
                                            <img src="<?= BASE_URL ?>/public/images/shop/details/2.jpg" width="640"
                                                height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery"
                                            href="<?= BASE_URL ?>/public/images/shop/details/3.jpg">
                                            <img src="<?= BASE_URL ?>/public/images/shop/details/3.jpg" width="640"
                                                height="530" alt="Image">
                                        </a>
                                        <a class="lightbox-image swiper-slide" data-fancybox="gallery"
                                            href="<?= BASE_URL ?>/public/images/shop/details/4.jpg">
                                            <img src="<?= BASE_URL ?>/public/images/shop/details/4.jpg" width="640"
                                                height="530" alt="Image">
                                        </a>
                                    </div>
                                    <!-- swiper pagination -->
                                    ...
                                    <div class="swiper single-product-nav-slider">
                                        <div class="swiper-wrapper">
                                            <div class="nav-item swiper-slide">
                                                <img src="<?= BASE_URL ?>/public/images/shop/details/nav1.jpg"
                                                    alt="Image" width="127" height="127">
                                            </div>
                                            <div class="nav-item swiper-slide">
                                                <img src="<?= BASE_URL ?>/public/images/shop/details/nav2.jpg"
                                                    alt="Image" width="127" height="127">
                                            </div>
                                            <div class="nav-item swiper-slide">
                                                <img src="<?= BASE_URL ?>/public/images/shop/details/nav3.jpg"
                                                    alt="Image" width="127" height="127">
                                            </div>
                                            <div class="nav-item swiper-slide">
                                                <img src="<?= BASE_URL ?>/public/images/shop/details/nav4.jpg"
                                                    alt="Image" width="127" height="127">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="product-detail-content">
                                ...
                                <div class="product-size-list">
                                    <div class="product-size-list-check">
                                        <input class="form-check-input" type="radio" name="flexRadioSizeList"
                                            id="sizeSList1">
                                ...
                                <p class="product-detail-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                                    sed do eiusmo tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minimo
                                    ...
                                    <div class="row mb-n3">
                                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-3">
                                            ...
                                            <div class="feature-two-item">
                                                <img class="icon" src="<?= BASE_URL ?>/public/images/icons/1.png"
                                                    width="44" height="38" alt="Icon"> <span
                                                    class="feature-two-title">Support 24/7</span>
                                            </div>
                                            <!--== End Feature Item ==-->
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-3">
                                            <!--== Start Feature Item ==-->
                                            <div class="feature-two-item">
                                                <img class="icon" src="<?= BASE_URL ?>/public/images/icons/3.png"
                                                    width="48" height="38" alt="Icon"> <span
                                                    class="feature-two-title">Card Payment</span>
                                            </div>
                                            <!--== End Feature Item ==-->
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 mb-3">
                                            <!--== Start Feature Item ==-->
                                            <div class="feature-two-item">
                                                <img class="icon" src="<?= BASE_URL ?>/public/images/icons/4.png"
                                                    width="50" height="38" alt="Icon"> <span
                                                    class="feature-two-title">Free Shipping</span>
                                            </div>
                                            <!--== End Feature Item ==-->
                                        </div>
                                    </div>
                    ...
                    <div class="nav product-detail-nav" id="product-detail-nav-tab" role="tablist">
                        ...
                        <button class="product-detail-nav-link" id="review-tab" data-bs-toggle="tab"
                    ...
                    <div class="tab-content" id="product-detail-nav-tabContent">
                        <div class="tab-pane fade show active" id="description" role="tabpanel"
                            ...
                            <p class="product-detail-nav-description">Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolor magna aliqua. Ut
                                ...
                                laudantium, totamhy rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi
                        ...
                        <div class="tab-pane" id="review" role="tabpanel" aria-labelledby="review-tab">
                            ...
                            <div class="product-review-item">
                                ...
                                <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed viverra
                                    ...
                                    Nascetur scelerisque massa sodales egestas augue neque euismod scelerisque
                                    viverra.
                                </p>
                    ...
                    <div class="swiper related-product-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="<?= BASE_URL ?>/public/images/shop/5.jpg" width="270" height="264"
                                            alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="<?= BASE_URL ?>/public/images/shop/6.jpg" width="270" height="264"
                                            alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="<?= BASE_URL ?>/public/images/shop/7.jpg" width="270" height="264"
                                            alt="Image-HasTech">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-item">
                                    <a class="product-item-thumb" href="shop-single-product.html">
                                        <img src="<?= BASE_URL ?>/public/images/shop/8.jpg" width="270" height="264"
                                            alt="Image-HasTech">
                                    </a>
