                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Thông Tin Chi Tiết Bài Viết</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <% } else if (blog) { %>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-muted">Tác giả: <%= blog.author %>
                                    </p>
                                    <p class="card-text"><small class="text-muted">Ngày đăng: <%=
                                        new Date(blog.createdAt).toLocaleDateString('vi-VN') %></small></p>
                                </div>
                            </div>
                            <% } %>
                </div>
