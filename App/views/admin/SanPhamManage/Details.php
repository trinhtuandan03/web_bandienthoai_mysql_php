                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Thông Tin Chi Tiết Sản Phẩm </h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <% product.images.forEach(function(img) { %>
                                    <div class="col-md-3 mb-2">
                                        <img src="<%= img %>" alt="ảnh" class="img-fluid rounded">
                                    </div>
                                    <% }) %>
                            </div>
                            <a href="/SanPhamManage/Index" class="btn btn-secondary mt-3">← Quay lại danh sách</a>
                            <% } %>
                </div>
